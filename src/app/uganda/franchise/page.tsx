...
export default function Page() {
    ...
    const stores = [
      { name: "Jibu Kyanja", address: "Plot 145, Kawempe", position: [0.3476, 32.5825] },
      { name: "Jibu Namuwongo", address: "Plot 177/178, Bukasa Rd", position: [0.3102, 32.6203] },
      { name: "Jibu Ggaba", address: "Plot 125, Ggaba", position: [0.2901, 32.6150] },
    ];
    ...
    return(
        <div>
            ...
            <div className="px-0 md:px-8 xl:px-32 py-8 ">
                <StoreLocator stores={stores} center={[0.2901, 32.6150]} />
            </div>
