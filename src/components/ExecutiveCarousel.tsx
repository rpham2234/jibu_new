  ...
  const franchisees = [
    {
        ...
        "role": "Franchisee in Rwamagana, Rwanda",
        "bio": "abc",
        "headshotUrl": "https://jibuco.com/wp-content/uploads/2022/10/Uwamahoro-Rehema-Franchisee-Rwamagana-min-731x1024.jpg"
      },
      {
        "id" :  2,
        "name": "Dorcus",
        "role": "Franchisee in Buruburu, Kenya",
        "bio": "abc",
        "headshotUrl": "https://jibuco.com/wp-content/uploads/2023/01/MG_2009-1-jpg.webp"
      },
      {
        "id" :  3,
        "name": "Mediatrice Muvuna",
        "role": "Franchisee in Kinamba, Musanze, Nyagatare - Rwanda",
        "bio": "abc",
        "headshotUrl": "https://jibuco.com/wp-content/uploads/2022/10/Mediatrice-Muvuna-Franchisee-Kinamba-min-731x1024.jpg"
      },
      {
        "id" :  4,
        "name": "Carol Mbabazi",
        "role": "Franchisee in Kicukiro & Sonatube, Rwanda",
        "bio": "abc",
        "headshotUrl": "https://jibuco.com/wp-content/uploads/2022/10/Carol-Mbabazi-Franchisee-Kicukiro-and-Sonatube-min-731x1024.jpg"
      },
          ...
          {items.map((item, i) => (
            <div key={i} data-slide={i} className="snap-start shrink-0 min-w-0 basis-[85%] sm:basis-[75%] md:basis-[48%] lg:basis-[32%]">
                <article className="bg-white rounded-2xl shadow-md overflow-hidden text-center">
                    {/* Keep headshotUrl inside card, keep aspect ratio */}
